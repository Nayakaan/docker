...
<main>
  <div class="bg-dark">
    <div class="date-bar-wrapper">
      <div class="date-bar">
        <div class="date-bar__select-wrapper">
          <form action="">
            <div class="form-select-wrapper">
              <select name="" id="" class="js-select2 date-bar__select form-select f-500">
        ...
        <div class="date-bar__list">
          <button type="button" class="date-bar__prev-btn">
            <span class="sr-only">Prev date</span>
          </button>
          <div class="date-bar__list-wrapper">
            <a href="#date1" class="date-bar__btn active">
              <span>Thu, Apr. 19</span>
            </a>
            <a href="#date2" class="date-bar__btn">
              <span>Fri, Apr. 19</span>
            </a>
          </div>
          <button type="button" class="date-bar__next-btn">
    ...
    <div class="container-md">
      <ul class="schedule-items-wrapper">
        <li class="schedule-item" id="date1">
          <p class="schedule-item__date f-700">Thursday, April 19</p>
          <ul>
            <li class="match-bet">
              <button type="button" class="match-bet__btn">
                <span class="match-bet__btn-label">Details</span>
              </button>
              <div class="match-bet__top">
                <span class="group">Group A</span>
                <span class="match-bet__hour">13:45</span>
              </div>
              <div class="match-bet__team match-bet__team--first">
                <div class="match-bet__icon-wrapper">
                  <img src="<?php echo get_template_directory_uri() . '/assets/public/images/teams/virtus-pro.png'?>" alt="">
                </div>
                <p class="match-bet__team-name">Virtus.pro</p>
                <span class="match-bet__value f-700">2.50</span>
              </div>
              <div class="match-bet__team match-bet__team--second">
                <div class="match-bet__icon-wrapper">
                  <img src="<?php echo get_template_directory_uri() . '/assets/public/images/teams/cloud9.svg'?>" alt="">
                </div>
                <p class="match-bet__team-name">Cloud9</p>
                <span class="match-bet__value f-700">2.50</span>
              </div>
              <div class="match-bet-dropdown-wrapper">
                ...
                <div class="match-bet-dropdown__link-wrapper">
                  <a href="#" class="btn-primary match-bet-dropdown__link">Bet Now</a>
                </div>
              </div>
            </li>
            <li class="match-bet">
              ...
              <div class="match-bet__team match-bet__team--first">
                ...
                <p class="match-bet__team-name">Outlaws</p>
                <span class="match-bet__value f-700">2.50</span>
              </div>
              <div class="match-bet__team match-bet__team--second">
                <div class="match-bet__icon-wrapper">
                ...
                <p class="match-bet__team-name">BlueJavs</p>
                <span class="match-bet__value f-700">2.50</span>
              </div>
              <div class="match-bet-dropdown-wrapper">
                <div class="match-bet-dropdown">
                  ...
                  <div class="match-bet-dropdown__team match-bet-dropdown__team--first">
                    ...
                    <p class="match-bet-dropdown__team-name">Outlaws</p>
                    <span class="match-bet-dropdown__value f-700">2.50</span>
                  </div>
                  <div class="match-bet-dropdown__team match-bet-dropdown__team--second">
                    <div class="match-bet-dropdown__team-icon-wrapper">
                    ...
                    <p class="match-bet-dropdown__team-name">BLueJavs</p>
                    <span class="match-bet-dropdown__value f-700">2.50</span>
                  </div>
                  <p class="match-bet-dropdown__vs">
                    vs
        ...
        <li class="schedule-item" id="date2">
          <p class="schedule-item__date f-700">Friday, April 20</p>
          <ul>
            <li class="match-bet">
              <button type="button" class="match-bet__btn">
                <span class="match-bet__btn-label">Details</span>
              ...
              <div class="match-bet__team match-bet__team--first">
                ...
                <p class="match-bet__team-name">Fnatic</p>
                <span class="match-bet__value f-700">2.50</span>
              </div>
              <div class="match-bet__team match-bet__team--second">
                <div class="match-bet__icon-wrapper">
                ...
                <p class="match-bet__team-name">Pride</p>
                <span class="match-bet__value f-700">2.50</span>
              </div>
              <div class="match-bet-dropdown-wrapper">
                <div class="match-bet-dropdown">
                  ...
                  <div class="match-bet-dropdown__team match-bet-dropdown__team--first">
                    ...
                    <p class="match-bet-dropdown__team-name">Fnatic</p>
                    <span class="match-bet-dropdown__value f-700">2.50</span>
                  </div>
                  <div class="match-bet-dropdown__team match-bet-dropdown__team--second">
                    <div class="match-bet-dropdown__team-icon-wrapper">
                    ...
                    <p class="match-bet-dropdown__team-name">Pride</p>
                    <span class="match-bet-dropdown__value f-700">2.50</span>
                  </div>
                  <p class="match-bet-dropdown__vs">
                    vs
            ...
            <li class="match-bet">
              ...
              <div class="match-bet__team match-bet__team--first">
                ...
                <p class="match-bet__team-name">AgentS</p>
                <span class="match-bet__value f-700">2.50</span>
              </div>
              <div class="match-bet__team match-bet__team--second">
                <div class="match-bet__icon-wrapper">
                ...
                <p class="match-bet__team-name">NONAME</p>
                <span class="match-bet__value f-700">2.50</span>
              </div>
              <div class="match-bet-dropdown-wrapper">
                <div class="match-bet-dropdown">
                  ...
                  <div class="match-bet-dropdown__team match-bet-dropdown__team--first">
                    ...
                    <p class="match-bet-dropdown__team-name">AgentS</p>
                    <span class="match-bet-dropdown__value f-700">2.50</span>
                  </div>
                  <div class="match-bet-dropdown__team match-bet-dropdown__team--second">
                    <div class="match-bet-dropdown__team-icon-wrapper">
                    ...
                    <p class="match-bet-dropdown__team-name">NONAME</p>
                    <span class="match-bet-dropdown__value f-700">2.50</span>
                  </div>
                  <p class="match-bet-dropdown__vs">
                    vs
